...
class TestsExpressions {
  ...
  def Test_interpreterExpr_Nl(): Unit = {
    assertEquals(NlValue, interpreterExpr(Nl, memory))
  }

  @Test
  def Test_interpreterExpr_Cst(): Unit = {
    assertEquals(CstValue("xxx"), interpreterExpr(Cst("xxx"), memory))
  }

  @Test
  def Test_interpreterExprVar_presente1(): Unit = {
    assertEquals(CstValue("xxx"), interpreterExpr(VarExp("X"), memory))
  }
  ...
  def Test_interpreterExprVar_presente3(): Unit = {
    assertEquals(NlValue, interpreterExpr(VarExp("Z"), memory))
  }

  @Test
  def Test_interpreterExprVar_absente(): Unit = {
    assertEquals(NlValue, interpreterExpr(VarExp("W"), memory))
  }
  ...
  def Test_interpreterExpr_Hd_OK3(): Unit = {
    assertEquals(CstValue("a-yyy"), interpreterExpr(Hd(VarExp("Y")), memory))
  }

  @Test
  def Test_interpreterExpr_Hd_NOK1(): Unit = {
    assertEquals(NlValue, interpreterExpr(Hd(VarExp("Z")), memory))
  }

  @Test
  def Test_interpreterExpr_Hd_NOK2(): Unit = {
    assertEquals(NlValue, interpreterExpr(Hd(VarExp("X")), memory))
  }
  ...
  def Test_interpreterExpr_Tl_OK3(): Unit = {
    assertEquals(CstValue("b-yyy"), interpreterExpr(Tl(VarExp("Y")), memory))
  }
  ...
  def Test_interpreterExpr_Tl_NOK1(): Unit = {
    assertEquals(NlValue, interpreterExpr(Tl(VarExp("Z")), memory))
  }

  @Test
  def Test_interpreterExpr_Tl_NOK2(): Unit = {
    assertEquals(NlValue, interpreterExpr(Tl(VarExp("X")), memory))
  }

  @Test
  def Test_interpreterExpr_Eq_true1(): Unit = {
    assertNotEquals(NlValue, interpreterExpr(Eq(Nl, Nl), memory))
  }

  @Test
  def Test_interpreterExpr_Eq_true2(): Unit = {
    val e: Expression = Cons(VarExp("X"), VarExp("Y"))
    assertNotEquals(NlValue, interpreterExpr(Eq(VarExp("X"), Hd(e)), memory))
  }

  @Test
  def Test_interpreterExpr_Eq_false1(): Unit = {
    assertEquals(NlValue, interpreterExpr(Eq(Nl, Cst("xxx")), memory))
  }

  @Test
  def Test_interpreterExpr_Eq_false2(): Unit = {
    val e: Expression = Cons(VarExp("X"), VarExp("Y"))
    assertEquals(NlValue, interpreterExpr(Eq(VarExp("Y"), Hd(e)), memory))
  }
  ...
  def Test_interpreterExpr_Expr2(): Unit = {
    ...
    assertEquals(NlValue, interpreterExpr(e, memory))
  }
